...
public class TestPart {
    ...
    private String demagStatus; // DeMag confirmation status ("Done")
    ...
    public String getCrackImagePath() {
        return crackImagePath;
    }

    public void setCrackImagePath(String crackImagePath) {
        this.crackImagePath = crackImagePath;
    }

    public String getDemagStatus() {
        return demagStatus;
    }

    public void setDemagStatus(String demagStatus) {
        this.demagStatus = demagStatus;
    }
